...
function workspace(status: 'DRAFT' | 'ACTIVE' = 'DRAFT'): SeasoningWorkspace {
  return {
    ...
    processes: [
      { workflowProcessNodeId: 'node-roll', workProcessId: 'ROLL', processOrder: 2, processName: '滚揉', basisQuantity: 1, basisUnit: 'kg', standardUsageSupported: true, bindings: [{ id: 1, workflowProcessNodeId: 'node-roll', workProcessId: 'ROLL', materialTypeId: 'M1', name: '辣椒粉', unit: 'g', dosagePerKgG: 5, subsequentPotRatio: .5, countInSeasoning: true, priceSnapshot: 18 }] },
      { workflowProcessNodeId: 'node-fry', workProcessId: 'FRY', processOrder: 3, processName: '炸水', basisQuantity: 1, basisUnit: 'kg', standardUsageSupported: true, bindings: [{ id: 2, workflowProcessNodeId: 'node-fry', workProcessId: 'FRY', materialTypeId: 'M1', name: '辣椒粉', unit: 'g', dosagePerKgG: 1.5, subsequentPotRatio: null, countInSeasoning: true, priceSnapshot: 18 }] },
    ],
  };
}
