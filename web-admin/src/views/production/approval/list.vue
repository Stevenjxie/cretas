  ...
  <div class="page-container">
    ...
    <el-card style="margin-top: 16px">
      ...
      >
          ...
          <template #default="{ row }">
            <div class="report-detail">
              <el-descriptions :column="3" border size="small">
                ...
                <el-descriptions-item label="领料出库">{{ formatQty(row.warehouseOutQuantity) }}</el-descriptions-item>
                <el-descriptions-item label="实际投料">{{ formatQty(row.feedInQuantity) }}</el-descriptions-item>
                <el-descriptions-item label="本批剩余/结转">{{ formatQty(row.carryoverQuantity) }}</el-descriptions-item>
        ...
        <el-table-column prop="feedInQuantity" label="实投" width="90">
          <template #default="{ row }">{{ formatQty(row.feedInQuantity) }}</template>
        </el-table-column>
        <el-table-column prop="carryoverQuantity" label="结转" width="90">
          <template #default="{ row }">{{ formatQty(row.carryoverQuantity) }}</template>
        </el-table-column>
