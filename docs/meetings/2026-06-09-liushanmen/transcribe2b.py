#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Transcribe Fengxing Road Side Road 2 2(1).m4a (六扇门 meeting follow-up) via faster-whisper large-v3 GPU."""
import os
os.environ["KMP_DUPLICATE_LIB_OK"] = "TRUE"  # must be before ctranslate2/torch import (OMP#15)
import time
from faster_whisper import WhisperModel

WAV = r"D:\Temp\fengxing2b.wav"
OUT_DIR = os.path.dirname(os.path.abspath(__file__))
TXT = os.path.join(OUT_DIR, "transcript-2b.txt")
SRT = os.path.join(OUT_DIR, "transcript-2b.srt")
