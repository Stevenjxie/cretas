...
1. **prod 没有任何租户能验完整能力**：MOCK_REST 有后厨、最近 30 天**没有 POS
   流水**；RES_3101_009 有 POS、**没有后厨数据**。下一轮的真前置条件是这个，
   不是「等上午额度充足」。
2. **口语族 0/6 是跨两个租户唯一稳定复现的缺陷**。
3. 「已给足门店+时间仍被反问」在 MOCK_REST 上 9 条、RES_3101_009 上 3 条，
