...
| SWEEP-D | 验证扫荡 批D C/F流 V2→V1 (~65项, 已V1项过滤: C-074/075/F-019~028/F-048~053) | Sonnet | (锁死) | subagent bg | fix worktree 按需 | docs/audits/liushanmen/ + matrix C/F 行 + test 10011 | 🟡 in-flight | 停在PR | brief=v0-sweep.md 批D; 矩阵标缺保持怀疑先取证(批B 12处误标); docs push 自查 |
