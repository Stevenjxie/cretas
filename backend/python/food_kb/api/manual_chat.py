...
5. “最近30天哪个时段生意最好”现在由历史时段表现 resolver 承接，按 POS 时间戳使用统一的午市/下午茶/晚市/夜宵边界；无时间戳记录不会硬塞进夜宵，而会如实披露。有金额权限时按营收排序，无金额权限时按单量排序。“最近30天食材成本占营收多少”按全店比率处理，泛指“食材”不再被误标成某个具体食材维度；点名具体食材时仍保留细粒度。当前“最近30天折扣力度多大”仍未闭环，可能澄清或拒答，不能宣称所有条件齐全的问法都已稳定回答。

例如首问“最近30天总营收是多少”或“最近30天加权毛利率是多少”而未写门店时，当前可回答全部门店合计并披露范围；历史时段表现与全店食材成本占比已有可执行口径，折扣力度问法仍未闭环。首问“比较 A 店宫保鸡丁 4–6 月销量”，追问“那成本和毛利呢”可沿用三项范围；若改问“换 B 店看 7 月”，则按新范围重新规划。"""
