...
2. **从零建首版与版本状态：** 先保存结构完整的 Workflow 草稿，再点击对应配置格添加主原料及实际需要的辅料、包材或副产。没有 BOM 时首次保存会创建首版草稿。顶部版本状态按产品分行区分 Workflow 草稿/已启用版本与 BOM 生效/草稿版本；有生效 BOM 但明细为空只能说“还没配辅料/包材”，不能误报“没有生效 BOM”。没有包材或副产本身不阻止激活。
