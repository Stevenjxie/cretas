...
_REQUEST_TEXT_TOKENS = {
    ...
    # ⛔ 只收「让利」这一族词。「优惠券/代金券」是券的发放与核销, 与折扣金额不是
    #    同一口径, 不登记 —— 不登记就是交给 L3, 那是安全的一侧。
    "discount": ("折扣", "让利", "打折", "满减", "折让"),
    # ⛔ 不收裸「采购」: 「采购花了多少钱」是领料花费(requisition_cost, #2043 修过),
    #    与供应商报价不是一个口径。只收明确指向**价格**的词。
    "supplier_price": ("供应商", "报价", "进价", "供货价", "采购价", "采购单价"),
