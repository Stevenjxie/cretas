...
CASES: List[Dict[str, Any]] = [
    ...
    {"q": "这月比上月好还是差，差在哪", "oral": True},
    {"q": "周末和平时哪个更赚钱，差多少", "oral": True},
    {"q": "哪个菜卖得好，哪个菜不赚钱", "oral": True},
    {"q": "人手够不够，要不要招人", "oral": True},
    {"q": "损耗高不高，主要是哪些东西", "oral": True},
    {"q": "最近生意怎么样，有什么要注意的", "oral": True},
