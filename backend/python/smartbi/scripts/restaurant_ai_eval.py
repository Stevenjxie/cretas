...
CASES: List[Dict[str, Any]] = [
    ...
    {"q": "最近三个月营收趋势", "contains": ["营收趋势"],
     "excludes": ["全部历史"]},
    {"q": "上上个月营收多少", "contains": ["2026-05-01 至 2026-05-31"]},
    {"q": "2025年全年营收多少", "contains": ["2025年"],
     "excludes": ["没有找到名为"]},
    {"q": "日月光店的营收", "contains": ["多家门店"]},
    {"q": "米饭和娃娃菜和招牌藤椒味(单人份)的销量",
     "contains": ["米饭", "娃娃菜"], "excludes": ["请指定其中一道"]},
    {"q": "哪些菜没人点", "contains": ["卖得最差"]},
    {"q": "外卖占了几成", "contains": ["外卖", "堂食", "单量占"]},
    {"q": "哪些食材快没了", "contains": ["补货"]},
    {"q": "翻台率怎么样", "contains": ["翻台率"], "excludes": ["操作已完成"]},
    {"q": "客单价最高的店是哪家", "contains": ["平均每单"],
     "excludes": ["没有找到名为"]},
    {"q": "米饭的销量、毛利率和成本分别是多少", "contains": ["「米饭」"]},
    {"q": "这个月生意怎么样，另外米饭卖得好不好",
     "contains": ["本月", "「米饭」"]},
    {"q": "先告诉我昨天的营收，再告诉我哪家店业绩最好",
