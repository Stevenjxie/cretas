...
PUBLIC_SOURCE_REGISTRY: Dict[str, SourceDefinition] = {
    ...
    "tencent_map_place_search": SourceDefinition(
        source_code="tencent_map_place_search",
        source_name="Tencent Location Service place search API",
        source_type="public_poi",
        access_mode="official_api",
        compliance_level="public_aggregate",
        ...
        requires_api_key=True,
        refresh_interval_hours=24,
        notes="Official place search API used for Tencent cross-check of competitor density and public POI signals.",
    ),
    "tencent_map_weather": SourceDefinition(
        source_code="tencent_map_weather",
        source_name="Tencent Location Service weather API",
        source_type="public_poi",
        access_mode="official_api",
        compliance_level="public_aggregate",
        base_url="https://apis.map.qq.com/",
        requires_api_key=True,
        refresh_interval_hours=6,
        notes="Official weather API used as a second weather context source.",
    ),
    "baidu_map_place_search": SourceDefinition(
        source_code="baidu_map_place_search",
        source_name="Baidu Maps official Place API",
        source_type="public_poi",
        access_mode="official_api",
        compliance_level="public_aggregate",
        ...
        requires_api_key=True,
        refresh_interval_hours=24,
        notes="Official Baidu Place API used as a third-party cross-check for trade-area competitor density and public POI detail signals.",
    ),
    "baidu_map_weather": SourceDefinition(
        source_code="baidu_map_weather",
        source_name="Baidu Maps official weather API",
        source_type="public_poi",
        access_mode="official_api",
        compliance_level="public_aggregate",
        base_url="https://api.map.baidu.com/",
        requires_api_key=True,
        refresh_interval_hours=6,
        notes="Official Baidu weather API used as an additional operating-context source for trade-area analysis.",
    ),
