...
class RestaurantGrossMarginChatRouteSelectorTest {
    ...
    @Test
    void springContextConstructsSelectorUsingTheServiceConstructor() {
        try (AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext()) {
            context.registerBean(RestaurantAgentRunService.class,
                    () -> mock(RestaurantAgentRunService.class));
