 ...
 * 更新人工成本配置请求 DTO.
 *
 * <p>Rule 17.1 cleanup (PR #370 audit). See {@link CreateLaborCostRequest}
 * for background. {@code id} comes from path; {@code factoryId} auto-filled;
 * other fields full-replace on PUT.
 *
 * @author Cretas Team
 * @since 2026-05-11
 */
@Data
@Schema(description = "更新人工成本配置请求")
