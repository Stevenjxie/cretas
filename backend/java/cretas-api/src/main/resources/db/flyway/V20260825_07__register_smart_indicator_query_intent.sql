...
VALUES (
    ...
    '["智能指标", "指标分析", "看指标", "客单价", "平均订单金额", "销售额", "营收", "订单数", ' ||
    '"库存", "库存价值", "不合格率", "质检合格率", "出品率", "单位成本", "日均产量", ' ||
    '"原料周转", "周转天数", "真空包装", "真空包装合格率", "良品率", "HACCP", "违规", ' ||
    '"今天怎么样", "现在状态如何", "几个红灯", "有什么需要关注", "哪个有问题", ' ||
    '"对比", "并排看", "几个指标", "溯源", "这批从哪来", "原料用了哪些", "召回查谁"]'::jsonb,
    90,
    TRUE,
    'LOW',
