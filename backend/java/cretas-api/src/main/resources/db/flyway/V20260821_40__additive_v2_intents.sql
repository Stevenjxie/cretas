...
VALUES
    (gen_random_uuid(), 'ADDITIVE_SMART_MATCH', '添加剂智能匹配', 'QUERY',
     ...
     '["智能匹配","查添加剂","这个添加剂","在系统里","VC 是什么","MSG 是什么","Sodium Benzoate","Aspartame","查 INS","INS 代码","俗名","英文名","查 山梨酸钾","识别这个添加剂"]',
    ...
    (gen_random_uuid(), 'ADDITIVE_BOM_COMPLIANCE', 'BOM 添加剂综合校验', 'ANALYSIS',
     ...
     '["BOM 合规","配方添加剂","BOM 添加剂","配方超限","X 产品 BOM 合规","查 BOM 添加剂","BOM 检查添加剂","配方违法添加剂","P-X 配方合规","卤猪蹄 BOM","产品 BOM 添加剂"]',
