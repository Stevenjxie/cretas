...
INSERT INTO ai_intent_configs (
    ...
    keywords, examples, sensitivity_level, is_active, description, created_at, updated_at
) VALUES
  (gen_random_uuid(), 'COLD_CHAIN_MONITORING', '冷链温控监测', 'WORKDESK',
   NULL,
   '["冷链","温控","冷藏","冷冻","冰柜","冷库","冷藏车","温度","偏离","报警"]',
   '["冷库今天温度怎么样","冷藏车有没有温控偏离","冷链监测情况"]',
   'LOW', true,
