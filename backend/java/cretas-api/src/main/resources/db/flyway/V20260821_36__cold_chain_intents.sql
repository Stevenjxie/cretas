...
--
-- 2026-05-21 hotfix: dropped `examples` column reference.
...
-- `example_queries`, not `examples`). Per .claude/rules/concurrent-edit-safety.md HARD
-- 3-strike comprehensive audit triggered after V_05 || syntax bug.
-- Example AI queries moved to inline SQL comments above; not persisted.
...
INSERT INTO ai_intent_configs (
  ...
  (gen_random_uuid(), 'COLD_CHAIN_MONITORING', '冷链温控监测', 'WORKDESK',
   NULL,
   '["冷链","温控","冷藏","冷冻","冰柜","冷库","冷藏车","温度","偏离","报警"]',
   'LOW', true,
